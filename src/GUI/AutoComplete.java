...
class AutoComplete {
    ...
    private JTextPane x = new JTextPane();
    ...
    public AutoComplete(JTextComponent textComp, Window mainWindow, ArrayList<String> words, Color popUpBackground, Color textColor, Color suggestionFocusedColor,int locX,int locY) {
...
//        autoSuggestionPopUpWindow.setOpacity(opacity);
    ...
    private void showPopUpWindow() {
        ...
        //show the pop up
        autoSuggestionPopUpWindow.setLocation(this.location.x+100, this.location.y+120);
        autoSuggestionPopUpWindow.setMinimumSize(new Dimension(textComp.getWidth(), 30));
    ...
    class SuggestionLabel extends JLabel {
        ...
        private final AutoComplete autoSuggestor;
        private Color suggestionsTextColor, suggestionBorderColor;
        public SuggestionLabel(String string, final Color borderColor, Color suggestionsTextColor, AutoComplete autoSuggestor) {
            super(string);
